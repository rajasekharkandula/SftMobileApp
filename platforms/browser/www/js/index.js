...
var app = {
    ...
    onDeviceReady: function() {
		...
		//window.open('http://www.saipalogbook.com','_system','location=no','hidden=yes','clearsessioncache=yes','toolbar=no','clearcache=yes','fullscreen=yes');
		
		window.location='http://www.saipalogbook.com';
